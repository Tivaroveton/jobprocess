...
class DropboxController extends BaseController{
  ...
  public function show(){
  	    ...
  	    $url = Storage::disk('dropbox')->url('internal/9999/1.png');
        //dd($url);
        $output = '<a href="'.$url.'" title="The Cleaner"><img src="'.$url.'" class="rounded"></a>';
        echo $output;
